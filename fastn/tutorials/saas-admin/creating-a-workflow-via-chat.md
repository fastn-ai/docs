...
> **Screenshot:** Chat interface showing a user prompt and the agent's response.
...
> **Screenshot:** Builder output showing generated workflow code and validation results.
...
The **TASKS** panel on the left side what the builder has done and what's pending.
