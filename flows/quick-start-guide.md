---
description: Create your first Fastn workflow automation in under 10 minutes. Connect an API trigger to Slack with no prior Fastn experience required.
---

# Quick start guide for Fastn workflow automation
