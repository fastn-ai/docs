...
![The Home screen with the build prompt](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/agent-home.jpg)

_Home opens on the **What do you want to build?** prompt, with example starter prompts beneath it._
...
![The workflow editor showing the flow diagram](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/workflow-editor-diagram.jpg)

_The Diagram tab draws the workflow from the code — it is read-only, and it cannot drift._
...
![The Test tab with ctx.input and ctx.headers](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/workflow-test.jpg)
...
If something is wrong, tell the agent rather than patching by hand. _"Skip deals under $500"_ or _"Add error handling when QuickBooks is down"_ and it rewrites the code, mappings and test cases together.
...
![The add trigger dialog offering webhook, schedule and app event](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/add-trigger-dialog.jpg)
...
Open **Widgets**, click **Add** under INTEGRATIONS, and pick the integration you just built. Then use the **Embed** tab to drop it into your product — see Embedding the widget.
...
{% hint style="success" %}
Done. From here, Core concepts explains the model underneath, [Workflows](../build/workflows.md) covers the editor in full, and [MCP gateway](../build/mcp-gateway.md) covers exposing the same integrations to an AI client.
{% endhint %}
