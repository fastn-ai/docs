...
![The roles screen](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/settings-roles.jpg)
...
**Custom role**, or **Duplicate** on a built-in, creates a role that _narrows_ its parent. You can take permissions away; you cannot add ones the parent does not have.

Assign a custom role to a person on [People](people.md), or — as the line at the top of this screen puts it — to an embed tier under [Billing](billing-and-limits.md), which is how you scope what an embedded end user may do.
