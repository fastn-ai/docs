...
![The Create Secret panel with Name, Type, Value, Customer and Environment fields](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/create-secret.jpg)

_New secret opens the Create Secret panel. The name is UPPER\_SNAKE\_CASE and becomes the argument to `fastn.secrets.get()`._
