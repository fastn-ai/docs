...
![The people list](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/settings-people.jpg)

| Column     | Notes                                                                       |
| ---------- | --------------------------------------------------------------------------- |
| **Person** | Name and email.                                                             |
| **Role**   | Their assigned role. **Change role** edits it.                              |
| **Status** | **Active** in every observed row. See [Statuses](people.md#statuses) below. |
...
The trash icon removes a person from the workspace. Their audit-log history stays, so _who did what_ remains answerable after they leave.
