...
![The profile page](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/profile.jpg)
...
{% hint style="info" %}
Your profile timezone changes how timestamps are _displayed_ to you. It does not change when a [schedule trigger](../build/triggers.md) fires — a schedule keeps the timezone it was saved with.
{% endhint %}
