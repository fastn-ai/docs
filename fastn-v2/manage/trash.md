...
![The trash page](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/settings-trash.jpg)
...
{% hint style="warning" %}
**The Actions tab currently does not load.** It sits on _Loading deleted actions…_ and never resolves. Deleted connector actions are still tracked — this is a defect in the tab, not evidence that nothing is there — but you cannot restore one from this screen while it persists.
{% endhint %}
