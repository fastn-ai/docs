---
description: >-
  Get told when something crosses a line you care about. Checked every 15
  minutes.
---
...
![The alerts page before any alert exists](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/activity-alerts.jpg)
...
![The alert editor](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/alert-editor.jpg)
...
{% hint style="warning" %}
Watch the unit when you type a threshold. The default alert is **Error rate is above 5** — five _percent_. Switch the metric to **Failed runs** and the same 5 means five _runs_, which on a busy workspace is a far tighter trigger than it looks.
{% endhint %}
