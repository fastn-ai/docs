...
The identifier is the stable one — use your own account ID rather than a display name. It is what you will see again as `endOrgId` in the [embed token](../embed/embedding-the-widget.md) response, and as the final `tenant` segment of a connection ID.
...
| [Embed tab](../embed/embedding-the-widget.md) | The **USER** selector scopes the generated snippet.         |
