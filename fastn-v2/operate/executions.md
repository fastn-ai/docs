...
![The executions log](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/activity-executions.jpg)
...
The **Executions** tab inside a workflow's editor filters differently: its pills are HTTP status codes — **All**, `200`, `201`, `400`, `404`, `422`, `500` — rather than run statuses. Use this page when you want to know _how a run ended_, and that tab when you want to know _what the caller got back_.
