---
description: >-
  One canonical endpoint per business entity, served by whichever providers your
  customers connect.
---
...
![Unified API categories](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/unified-apis.jpg)
...
![The CRM unified surface, showing the Account entity](https://raw.githubusercontent.com/fastn-ai/docs/docs-v2/.gitbook/assets/unified-api-crm-detail.jpg)

Opening a category swaps the pane for a detail view with the breadcrumb **Unified APIs / \<Category>** and two chips, _N entities_ and _N providers_. **The URL does not change when you do this**, so there is no link you can send someone that opens a category directly.
