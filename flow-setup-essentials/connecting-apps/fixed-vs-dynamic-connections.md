...
* **Widget created** — Build a widget that includes the connector as a dependency. The widget provides the UI through which tenants authenticate. See [Building and configuring widgets in Fastn](../../embedded-integrations-1/getting-started-with-fastns-embedded-experience/building-and-configuring-widgets-in-fastn.md).
...
* [Building and configuring widgets in Fastn](../../embedded-integrations-1/getting-started-with-fastns-embedded-experience/building-and-configuring-widgets-in-fastn.md) — Create the widget that powers dynamic connections
