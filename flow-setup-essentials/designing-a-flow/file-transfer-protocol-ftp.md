...
<figure><img src="../../.gitbook/assets/image (27).png" alt="File Transfer Protocol component in the Fastn flow editor"><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (28).png" alt="Connection type selection dropdown with FTP, FTPS, and SFTP options"><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (31).png" alt="FTP account connection panel with option to connect existing or create manual credentials"><figcaption></figcaption></figure>

<figure><img src="../../.gitbook/assets/image (30).png" alt="Manual credentials form for creating a new FTP connection"><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (32).png" alt="FTP operation selection and file path configuration fields"><figcaption></figcaption></figure>

* **Run the Flow**\
  Save and run the flow. The selected file operation will execute automatically.

<figure><img src="../../.gitbook/assets/image (33).png" alt="Flow execution results after running the FTP file operation"><figcaption></figcaption></figure>
