...
| -------------------------------------------------------- | ------------------------------------------ | -------------------------- |
| [Skip](flow-step-settings.md#skip-a-step)                | Temporarily disable a step during testing  | Three-dot menu on the step |
| [Step notes](flow-step-settings.md#step-notes)           | Document the purpose or logic of a step    | Settings tab               |
| [Step labels](flow-step-settings.md#step-labels)         | Visually group related steps on the canvas | Settings tab               |
| [Retry mechanism](flow-step-settings.md#retry-mechanism) | Automatically retry a step on failure      | Settings tab               |
