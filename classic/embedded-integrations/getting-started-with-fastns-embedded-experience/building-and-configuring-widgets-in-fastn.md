...
* [How to set up an activation flow](../../../tutorials-1/understanding-flow-types/how-to-set-up-an-activation-flow.md) — build a custom activation flow from scratch
* [How to set up a configuration flow](../../../tutorials-1/understanding-flow-types/how-to-set-up-a-configuration-flow-in-fastn/) — define form fields for widget configuration
...
* [Setting up a Google Drive to GCS migration widget](../../../tutorials-1/data-migrations/setting-up-a-google-drive-to-gcs-migration-widget.md) — end-to-end example with Pre-Auth, Post-Auth, and Post-Auth & Configured visibility
