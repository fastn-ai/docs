...
There is no sort control. The list pages at 24 per page with a footer reading `1–24 of 415`; the page number is not kept in the URL, so a deep link always lands on page one.
