...
* [Flow Setup Essentials](flows/flow-setup-essentials/README.md)
  ...
  * [Designing a Flow](flows/flow-setup-essentials/designing-a-flow/README.md)
    * [Connect external apps in Fastn flows](flows/flow-setup-essentials/designing-a-flow/connectors.md)
    * [Query the database in Fastn flows](flows/flow-setup-essentials/designing-a-flow/database.md)
    * [Map and transform data in Fastn flows](flows/flow-setup-essentials/designing-a-flow/data-mapper.md)
    * [Use variables in Fastn flows](flows/flow-setup-essentials/designing-a-flow/variables.md)
    * [Add conditional logic with Switch in Fastn](flows/flow-setup-essentials/designing-a-flow/switch.md)
    * [Repeat actions with Loop in Fastn flows](flows/flow-setup-essentials/designing-a-flow/loop.md)
    * [Download files in Fastn flows](flows/flow-setup-essentials/designing-a-flow/download-file.md)
    * [Convert data formats in Fastn flows](flows/flow-setup-essentials/designing-a-flow/converter.md)
    * [Write custom code in Fastn flows](flows/flow-setup-essentials/designing-a-flow/custom-code.md)
    ...
    * [Log and debug Fastn flows](flows/flow-setup-essentials/designing-a-flow/logger.md)
    * [File Transfer Protocol (FTP)](flows/flow-setup-essentials/designing-a-flow/file-transfer-protocol-ftp.md)
    * [Set up triggers for Fastn flows](flows/flow-setup-essentials/designing-a-flow/trigger.md)
    * [Summarization Chain](flows/flow-setup-essentials/designing-a-flow/summarization-chain.md)
    * [Transform flow data in Fastn](flows/flow-setup-essentials/designing-a-flow/flow-transformation/README.md)
      * [Filter data in Fastn flows](flows/flow-setup-essentials/designing-a-flow/flow-transformation/filter.md)
      * [Limit records in Fastn flows](flows/flow-setup-essentials/designing-a-flow/flow-transformation/limit.md)
      * [Split data into branches in Fastn flows](flows/flow-setup-essentials/designing-a-flow/flow-transformation/split.md)
      * [Aggregate data in Fastn flows](flows/flow-setup-essentials/designing-a-flow/flow-transformation/aggregate.md)
      * [Merge data branches in Fastn flows](flows/flow-setup-essentials/designing-a-flow/flow-transformation/merge.md)
